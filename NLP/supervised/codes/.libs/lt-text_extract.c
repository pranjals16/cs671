...
/* ./.libs/lt-text_extract.c - temporary wrapper executable for .libs/text_extract
   Generated by libtool (GNU libtool) 2.4

   The text_extract program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "text_extract"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# text_extract - temporary wrapper script for .libs/text_extract\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The text_extract program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"text_extract:text_extract:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"text_extract:text_extract:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"text_extract:text_extract:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
