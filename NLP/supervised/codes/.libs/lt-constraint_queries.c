...
/* ./.libs/lt-constraint_queries.c - temporary wrapper executable for .libs/constraint_queries
   Generated by libtool (GNU libtool) 2.4

   The constraint_queries program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/usr/lib:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/lib:/usr/bin:";
const char * TARGET_PROGRAM_NAME = "constraint_queries"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# constraint_queries - temporary wrapper script for .libs/constraint_queries\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The constraint_queries program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  generated_by_libtool_version='2.4'\n", f);
  fputs ("  notinst_deplibs=' /usr/lib/libxml2.la /usr/lib/libcurl.la /usr/lib/libidn.la /usr/lib/libintl.la /usr/lib/libiconv.la /usr/lib/libssh2.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("        lt_dump_D=`$ECHO \"X$lt_script_arg0\" | /usr/bin/sed -e 's/^X//' -e 's%/[^/]*$%%'`\n", f);
  fputs ("        test \"X$lt_dump_D\" = \"X$lt_script_arg0\" && lt_dump_D=.\n", f);
  fputs ("        lt_dump_F=`$ECHO \"X$lt_script_arg0\" | /usr/bin/sed -e 's/^X//' -e 's%^.*/%%'`\n", f);
  ...
  fputs ("    echo \"constraint_queries:constraint_queries:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"constraint_queries:constraint_queries:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"constraint_queries:constraint_queries:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    *[\\\\/].libs ) thisdir=`$ECHO \"$thisdir\" | /usr/bin/sed 's%[\\\\/][^\\\\/]*$%%'` ;;\n", f);
  fputs ("    .libs )   thisdir=. ;;\n", f);
  fputs ("    esac\n", f);
  fputs ("  fi\n", f);
  fputs ("\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='constraint_queries'\n", f);
  ...
  fputs ("    PATH=/usr/lib:/usr/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/usr/lib:$PATH\"\n", f);
  fputs ("\n", f);
