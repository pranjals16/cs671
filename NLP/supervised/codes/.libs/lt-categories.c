...
/* ./.libs/lt-categories.c - temporary wrapper executable for .libs/categories
   Generated by libtool (GNU libtool) 2.4

   The categories program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "categories"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# categories - temporary wrapper script for .libs/categories\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The categories program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"categories:categories:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"categories:categories:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"categories:categories:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
