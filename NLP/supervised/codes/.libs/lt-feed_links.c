...
/* ./.libs/lt-feed_links.c - temporary wrapper executable for .libs/feed_links
   Generated by libtool (GNU libtool) 2.4

   The feed_links program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "feed_links"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# feed_links - temporary wrapper script for .libs/feed_links\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The feed_links program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"feed_links:feed_links:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"feed_links:feed_links:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"feed_links:feed_links:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
